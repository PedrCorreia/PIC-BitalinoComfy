...
class SynthNode:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "buffer_size": ("INT", {"default": 10, "min": 1, "max": 60, "step": 1}),  # Buffer size in seconds - this is time-based
    ...
    def _plot_data(self, fx, y, as_points=False):
        ...
        try:
            from .plot_node import PygamePlotNode
            
            # Configure the plot node with our fps and sampling rate settings
            plot_node = PygamePlotNode()
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "SynthNode": "Synthetic Data Generator (with Plot)"
}
