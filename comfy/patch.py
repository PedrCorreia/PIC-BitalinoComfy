...
print("Patched huggingface_hub.utils.OfflineModeIsEnabled")
...
class JetsonCacheManager:
    ...
    def redirect_environment_vars(self):
        ...
        print("JetsonCacheManager redirect_environment_vars end")
