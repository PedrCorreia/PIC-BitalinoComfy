...
class ComfySignalConnectorNode:
    ...
    def _background_link(self, signal_id, stop_flag):
    ...
    def connect(self, signal_id):
        ...
        if signal_id not in self._threads or not self._threads[signal_id].is_alive():
            ...
            t = threading.Thread(target=self._background_link, args=(signal_id, stop_flag), daemon=True)
